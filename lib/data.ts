...
export const products: Product[] = [
  {
    ...
    price: 3500,
    image: "/products/marquise-bag-1.jpg",
    images: ["/products/marquise-bag-1.jpg"],
    category: "Totes",
    description: "The signature Marquise Vault tote, crafted for elegance and everyday luxury.",
    details: [
      "Premium leather construction",
      "Spacious interior",
      "Signature M branding",
      "Top handle design",
    ],
    colors: ["Black"],
    inStock: true,
  ...
  },
  {
    ...
    brand: "MARQUISE VAULT",
    price: 3200,
    image: "/products/marquise-bag-2.jpg",
    images: ["/products/marquise-bag-2.jpg"],
    category: "Shoulder Bags",
    description: "A relaxed, slouchy silhouette perfect for effortless style.",
    details: [
      "Soft, supple leather",
  ...
  },
  {
    ...
    brand: "MARQUISE VAULT",
    price: 3800,
    image: "/products/marquise-bag-3.jpg",
    images: ["/products/marquise-bag-3.jpg"],
    category: "Totes",
    description: "Clean lines and structured design for the modern minimalist.",
    details: [
      "Structured shape",
  ...
  },
  {
    ...
    brand: "MARQUISE VAULT",
    price: 2500,
    image: "/products/marquise-bag-4.jpg",
    images: ["/products/marquise-bag-4.jpg"],
    category: "Clutches",
  ...
  },
  {
    ...
    images: ["/products/marquise-bag-2.jpg"],
    category: "Totes",
    description: "Designed for the modern urbanite, combining style with functionality.",
    details: [
      "Spacious main compartment",
      "Dual handles for comfort",
      "Premium hardware details",
  ...
  },
  {
    ...
    images: ["/products/marquise-bag-4.jpg"],
    category: "Totes",
    description: "Your everyday essential, combining practicality with understated luxury.",
    details: [
      "Versatile design",
      "Reinforced handles",
