...
export const products: Product[] = [
  ...
  },
  {
    ...
    category: "Totes",
    description: "A sleek and functional tote bag featuring secure zip closure, two compartments with magnetic closures, and premium stainless-steel accessories that are fade-resistant and maintain their shine over time. Crafted from high-quality PU leather.",
    details: [
